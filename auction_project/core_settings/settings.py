...
SECRET_KEY = 'django-insecure-h!%(snxnj2+&apwss$cx&toz8w_*nm*e59qjmojo2gsbfipboi'
...
#if u want to use sqlite, then change USE_POSTGRES to 0, if postgres then chango to 1
